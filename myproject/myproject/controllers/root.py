...
class RootController(BaseController):
    ...
    @expose('myproject.templates.contact')
    #@require(predicates.is_user('editor', msg=l_('Only for the editor')))
    def contact(self, **kw):
        """Illustrate how a page exclusive for the editor works."""
        return dict(page='contact')

    @expose('myproject.templates.services')
    #@require(predicates.is_user('editor', msg=l_('Only for the editor')))
    def services(self, **kw):
        """Illustrate how a page exclusive for the editor works."""
        return dict(page='services')

    @expose('myproject.templates.gallery')
    #@require(predicates.is_user('editor', msg=l_('Only for the editor')))
    def gallery(self, **kw):
        """Illustrate how a page exclusive for the editor works."""
        return dict(page='gallery')

    @expose('myproject.templates.generate_leads')
    #@require(predicates.is_user('editor', msg=l_('Only for the editor')))
    def generate_leads(self, **kw):
        """Illustrate how a page exclusive for the editor works."""
        return dict(page='generate_leads')

    @expose('myproject.templates.properties_project')
    #@require(predicates.is_user('editor', msg=l_('Only for the editor')))
    def properties_project(self, **kw):
        """Illustrate how a page exclusive for the editor works."""
        return dict(page='properties_project')

    @expose('myproject.templates.properties_project_posted_status')
    #@require(predicates.is_user('editor', msg=l_('Only for the editor')))
    def properties_project_posted_status(self, **kw):
        """Illustrate how a page exclusive for the editor works."""
        return dict(page='properties_project_posted_status')
